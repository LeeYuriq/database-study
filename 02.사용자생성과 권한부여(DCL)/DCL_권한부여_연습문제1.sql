...
-- 사용자 생성
CREATE USER 'director'@'%' IDENTIFIED BY '12345';
GRANT ALL PRIVILEGES ON *.* TO 'director'@'%' WITH GRANT OPTION;
CREATE USER 'ceo'@'%' IDENTIFIED BY '12345';
GRANT SELECT ON *.* TO 'ceo'@'%';
CREATE USER 'staff'@'localhost' IDENTIFIED BY '12345';
GRANT INSERT, UPDATE, DELETE, SELECT ON shopdb.* TO 'staff'@'localhost'; 
...
CREATE USER 'admin_user'@'%' IDENTIFIED BY '12345';
